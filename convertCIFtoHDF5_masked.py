"""
This script will allow the user to convert a cif dataset to a hdf5 dataset. The masks of the cif data are applied to the output images. The background is removed."
...
def __main__():
    ...
    if (len(sys.argv) < 4 or len(sys.argv) > 6):
        ...
        if (len(sys.argv) == 5):
            ...
            convertCIF2HDF5(sys.argv[1], sys.argv[2], int(sys.argv[3]), maxNumbers=int(sys.argv[4]),channelsString=sys.argv[5], masked = True)
        else:
